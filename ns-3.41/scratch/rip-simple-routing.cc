...
main(int argc, char** argv)
{
    ...
    {
        // It'll do nothing because it seems that the config item has been removed ... may add it back
        Config::SetDefaultFailSafe("ns3::Rip::SplitHorizon", EnumValue(RipNg::SPLIT_HORIZON));
    }
    else
    {
